...
## 安装
- [安装版 (.exe)](https://github.com/slahserx/slahser_player/releases/download/v1.0.0/slahser_player_setup_1.0.0.exe) - 推荐大多数用户使用
- [便携版 (.zip)](https://github.com/slahserx/slahser_player/releases/download/v1.0.0/slahser_player_1.0.0_portable.zip) - 无需安装，解压即用
