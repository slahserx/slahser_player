...
$portableZip = ".\release\slahser_player_0.8.0_portable.zip"
...
Write-Host "  Installer created: .\release\slahser_player_setup_0.8.0.exe" -ForegroundColor Green
...
Write-Host "  - slahser_player_setup_0.8.0.exe (Installer)" -ForegroundColor Green
Write-Host "  - slahser_player_0.8.0_portable.zip (Portable Version)" -ForegroundColor Green
